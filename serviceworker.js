...
const fetchResponders = {
    NetworkFirst: networkFirstFetchResponder,
    CacheFirst: cacheFirstFetchResponder,
}

const selectedFetchResponder = fetchResponders.CacheFirst
self.addEventListener("fetch", selectedFetchResponder);



async function networkFirstFetchResponder(event){
    event.respondWith(
        (async () => {
            try {
...
async function cacheFirstFetchResponder(event){
    event.respondWith(
